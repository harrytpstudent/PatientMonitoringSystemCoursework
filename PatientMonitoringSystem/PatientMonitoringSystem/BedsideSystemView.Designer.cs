namespace PatientMonitoringSystem
{
	partial class BedsideSystemView
	{
		...
		private void InitializeComponent()
		{
			...
			this.ModuleTypeCombo = new System.Windows.Forms.ComboBox();
			...
			this.BottomPanel.Controls.Add(this.ModuleTypeCombo);
			...
			// ModuleTypeCombo
			// 
			this.ModuleTypeCombo.FormattingEnabled = true;
			this.ModuleTypeCombo.Items.AddRange(new object[] {
            "Blood Pressure",
            "Oxygen Level"});
			this.ModuleTypeCombo.Location = new System.Drawing.Point(296, 16);
			this.ModuleTypeCombo.Name = "ModuleTypeCombo";
			this.ModuleTypeCombo.Size = new System.Drawing.Size(121, 21);
			this.ModuleTypeCombo.TabIndex = 5;
			// 
			// label2
			// 
		...
		private System.Windows.Forms.ComboBox ModuleTypeCombo;
	}
}
